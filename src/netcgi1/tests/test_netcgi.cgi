...
print_string "<form action=\"test_netcgi.cgi\" method=GET>\n";
...
print_string "<form action=\"test_netcgi.cgi\" method=POST>\n";
print_string "<input type=text name=line>\n";
print_string "<input type=submit name=submit value=\"Submit\">\n";
print_string "</form>\n";

print_string "<h1>POST FORM-encoded form</h1>\n";
print_string "<form action=\"test_netcgi.cgi\" method=POST enctype=\"multipart/form-data\">\n";
print_string "<input type=text name=line>\n";
