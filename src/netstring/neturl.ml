 ...
 * 
 * $Log$
 * Revision 2.5  2006/03/06 16:31:03  stolpmann
 ...
 *
 * Revision 2.4  2005/01/26 11:51:40  stolpmann
 * 	Fix: Encoding of spaces in URLs. In previous versions, the plus
 * sign was handled as equal to %20 everywhere in the URL. This is wrong.
 * The plus sign has only a special meaning in the query part of the URL.
 *
