 ...
 * 
 * $Log$
 * Revision 1.12  2005/07/25 22:36:41  stolpmann
 * Merge of nethttpd.
 * Adding the "overview" section to Nethttpd_types.
 * Cosmetic fixes.
 * Release updates.
 *
 * Revision 1.11  2005/06/27 13:55:36  stolpmann
 * Fix write_mime_message: The argument [crlf] is passed down to recursive
 * activations of the function.
 *
 * Revision 1.10.2.1  2005/04/30 16:31:18  stolpmann
 ...
 *
 * Revision 1.8  2004/05/30 21:24:04  stolpmann
 * 	Fixed bug in method [field] of [basic_mime_header]
 *
 * Revision 1.7  2002/06/09 11:35:16  stolpmann
 * 	Passing ~strip as suggested by Matt Armstrong.
 *
 * Revision 1.6  2002/02/01 23:26:22  stolpmann
 * 	Fixed some problems with mail from the real world
 *
 * Revision 1.5  2002/01/23 22:22:44  stolpmann
 * 	Fix: method [content_transfer_encoding] returns the token
 * in lowercase characters (this field is case-insensitive)
 * 	Fix: The method [open_value_rd] of class [memory_mime_body]
 * works now. It returns now the latest version of the contents, and
 * not the initial value of the contents.
 * 	Fix: Reading from encoded mail bodies works again. The
 * intermediate channel was not closed.
 * 	New functions: [encode_mime_body], [write_mime_message]
 *
 * Revision 1.4  2002/01/21 00:46:49  stolpmann
 * 	Follow-up change: Calling [read_header] with ~strip:true.
 *
 * Revision 1.3  2002/01/14 01:09:07  stolpmann
 * 	[See also revision 1.3 of netmime.mli]
