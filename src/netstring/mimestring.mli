 ...
 *
 * $Log$
 * Revision 2.12  2004/07/10 23:43:06  stolpmann
 * 	ocamldoc
 *
 * Revision 2.11  2004/07/06 15:20:53  stolpmann
 * 	Bugfixes: write_value now correctly folds long encoded words.
 *
 * Revision 2.10  2004/07/04 18:51:54  stolpmann
 * 	Added: split_mime_type, split_uri
 *
 * Revision 2.9  2004/06/15 23:53:27  stolpmann
 * 	ocamldoc
 *
 * Revision 2.8  2002/02/01 23:27:31  stolpmann
 * 	write_header: The end-of-line characters in the middle of the
 * field can be separately specified with the soft_eol argument.
 *
 * Revision 2.7  2002/01/23 22:15:18  stolpmann
 * 	New function: [create_boundary]
 *
 * Revision 2.6  2002/01/21 00:45:39  stolpmann
 ...
 *
 * Revision 2.5  2002/01/12 18:07:34  stolpmann
 ...
 *
 * Revision 2.4  2002/01/06 02:22:09  stolpmann
 ...
 * parser.
 *
 * Revision 2.3  2001/12/28 21:11:36  stolpmann
 * 	Using the new Netstream interface.
 *
 * Revision 2.2  2001/10/14 15:45:22  stolpmann
 * 	Added a comment.
 *
