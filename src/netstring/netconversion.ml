 ...
 * 
 * $Log$
 * Revision 2.20  2004/07/11 15:41:18  stolpmann
 * 	Added: IBM-1047 charset
 *
 * Revision 2.19  2004/07/08 22:10:18  stolpmann
 * 	Adding accelerators for character set conversion.
 *
 * Revision 2.18  2004/07/07 22:41:53  stolpmann
 * 	Added Netulex, Netaux.ArrayAux.
 * 	Some improvements in Netconversion.
 *
 * Revision 2.17  2004/06/20 13:12:37  stolpmann
 * 	Added some encoding names (code pages)
 *
 * Revision 2.16  2004/06/09 22:51:56  stolpmann
 * 	Enhanced cursors: Support for UTF-16 with BOMs, support for
 * incomplete multi-byte characters,b litting functions.
 * 	Added ocamldoc to Netconversion.
 * 	Updated test_recode: New tests for cursors.
 *
 * Revision 2.15  2003/06/17 18:33:05  stolpmann
 * 	Fix: "recode" works now if the reader runs into an invalid
 * byte sequence that should be ignored. New exception Malformed_code_read
 * (raised by readers) signals this condition.
 *
 * Revision 2.14  2003/06/17 15:33:33  stolpmann
 * 	Fix: correcting slice_blen by the size of the byte order
 * mark (UTF-16)
 *
 * Revision 2.13  2003/06/17 15:10:29  stolpmann
 * 	Fix: In "recode", it was possible that the max_chars parameter
 * was ignored
 *
 * Revision 2.12  2003/06/04 19:21:51  stolpmann
 * 	compile fixes
 *
 * Revision 2.11  2003/06/03 18:58:23  stolpmann
 * 	Fine-tuning
 *
 * Revision 2.10  2003/04/21 22:01:35  stolpmann
 ...
 *
 * Revision 2.9  2003/04/06 22:10:58  stolpmann
 * 	Reimplementation of the conversions, now using an intermediate
 * array "slice"
 *
 * Revision 2.8  2002/10/04 20:54:31  stolpmann
 * 	Also accepting "MACROMAN" for Macintosh Roman encoding.
 *
 * Revision 2.7  2002/08/22 21:49:59  stolpmann
 * 	Fix: ISO-8859-16 is ascii-compatible, too.
 *
 * Revision 2.6  2002/07/06 16:23:23  stolpmann
 ...
 * 50 bytes.
 *
 * Revision 2.5  2002/07/03 01:15:57  stolpmann
 * 	New: `Enc_subset
 * 	New: is_single_byte
 * 	New: to_unicode
 *
 * Revision 2.4  2002/06/23 20:58:59  stolpmann
 * 	Added: Support for ISO-8858-16 character encoding
 *
 * Revision 2.3  2002/06/23 19:47:03  stolpmann
 ...
 *
 * Revision 2.2  2001/11/15 22:09:50  stolpmann
 * 	Fix: write_utf16_le/_be generate correct surrogate pairs.
 *
