 ...
 * 	Fixed dl model
 *
 * Revision 2.5  2002/07/06 16:26:25  stolpmann
 ...
 *
 * Revision 2.4  2001/12/22 09:18:02  pdoane
 * 	Call Netchannels.lexbuf_of_in_obj_channel instead of
 * Lexing.from_function
 *
 * Revision 2.3  2001/12/16 20:25:02  pdoane
 * 	Updated to use Netchannels
 *
 * Revision 2.2  2001/12/07 00:36:26  stolpmann
 * 	Added forgotten element <tbody>.
 *
