 ...
 * 
 * $Log$
 * Revision 1.19  2005/04/14 20:13:19  stolpmann
 * Using Unix.single_write instead of Unix.write.
 *
 * Revision 1.18  2004/07/11 15:40:29  stolpmann
 * 	Added: enhanced_input
 *
 * Revision 1.17  2004/07/10 23:42:36  stolpmann
 * 	New: delegation classes
 * 	New: Arg eol of lift_in
 * 	ocamldoc
 *
 * Revision 1.16  2004/05/30 21:27:14  stolpmann
 ...
 *
 * Revision 1.15  2002/11/01 17:11:07  stolpmann
 * 	Changed EAGAIN -> EINTR
 *
 * Revision 1.14  2002/10/26 20:47:37  stolpmann
 ...
 *
 * Revision 1.13  2002/10/24 23:33:23  stolpmann
 * 	New class output_null that simply discards any output
 *
 * Revision 1.12  2002/02/02 23:53:06  stolpmann
 * 	New: input_command, output_command
 *
 * Revision 1.11  2002/02/02 19:09:43  stolpmann
 * 	Important optimization: output_filter#output_channel processes
 * the channel block by block, so large buffers are avoided.
 *
 * Revision 1.10  2002/01/12 18:35:17  stolpmann
 * 	Added ?onclose for some output classes.
 *
 * Revision 1.9  2002/01/06 02:20:13  stolpmann
 * 	New optional arguments ?pos and ?len for class [input_string].
 *
 * Revision 1.8  2002/01/05 22:43:54  stolpmann
 * 	New: classes [input_filter], [output_filter]
 *
 * Revision 1.7  2002/01/02 22:55:09  stolpmann
 * 	Added: [input_netbuffer], [output_netbuffer], [pipe]. New
 * exception [Buffer_underrun].
 *
 * Revision 1.6  2001/12/22 09:17:15  pdoane
 ...
 *
 * Revision 1.5  2001/11/11 21:14:23  pdoane
 * 	Fixed bugs in the verification of arguments to the input and
 * 	really_input methods of input_string.
 *
 * Revision 1.4  2001/10/06 23:56:16  stolpmann
 * 	[tempfile_output_channel]: works now for multiple commit/rollback
 * cycles. The problem was that the channel buffer of transch_in lost
 * the synchronization with the actual tempfile.
 *
 * Revision 1.3  2001/09/30 00:01:46  stolpmann
