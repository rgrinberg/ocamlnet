...
(** This module has almost the same signature as the version of [Netcgi_compat]
  * shipped with [netcgi], the revised version of this library. This makes
  * it possible to build programs with either [cgi] or [netcgi] by 
  * adding 
  *
  * {[ open Netcgi_compat ]}
  *
  ...
  *
  * {b For new projects it is strongly recommended to use the new API of
  * [netcgi] instead of [Netcgi_compat]!}
 *)
